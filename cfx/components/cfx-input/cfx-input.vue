<template>
  ...
  >
    ...
    <view class="u-input__right-icon u-flex">
      ...
      >
        <cfx-icon size="32" name="close-circle-fill" color="#c0c4cc" />
      </view>
      ...
      >
        <cfx-icon name="arrow-down-fill" size="26" color="#c0c4cc"></cfx-icon>
      </view>
    </view>
  </view>
</template>
...
.u-input {
  ...
  &--border {
    border-radius: 6rpx;
    border-radius: 4px;
    border: 1px solid $cfx-form-item-border-color;
  }

  &--error {
    border-color: $cfx-type-error !important;
  }
