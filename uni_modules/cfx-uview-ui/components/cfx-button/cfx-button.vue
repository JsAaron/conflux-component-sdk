...
.u-btn {
  ...
  &--primary {
    color: #ffffff;
    border-color: $cfx-type-primary;
    background-color: $cfx-type-primary;
  }

  &--success {
    color: #ffffff;
    border-color: $cfx-type-success;
    background-color: $cfx-type-success;
  }

  &--error {
    color: #ffffff;
    border-color: $cfx-type-error;
    background-color: $cfx-type-error;
  }

  &--warning {
    color: #ffffff;
    border-color: $cfx-type-warning;
    background-color: $cfx-type-warning;
  }
  ...
  &--primary--disabled {
    ...
    border-color: $cfx-type-primary-disabled !important;
    background-color: $cfx-type-primary-disabled !important;
  }

  &--success--disabled {
    color: #ffffff !important;
    border-color: $cfx-type-success-disabled !important;
    background-color: $cfx-type-success-disabled !important;
  }

  &--error--disabled {
    color: #ffffff !important;
    border-color: $cfx-type-error-disabled !important;
    background-color: $cfx-type-error-disabled !important;
  }

  &--warning--disabled {
    color: #ffffff !important;
    border-color: $cfx-type-warning-disabled !important;
    background-color: $cfx-type-warning-disabled !important;
  }

  &--primary--plain {
    color: $cfx-type-primary !important;
    border-color: $cfx-type-primary-disabled !important;
    background-color: $cfx-type-primary-light !important;
  }

  &--success--plain {
    color: $cfx-type-success !important;
    border-color: $cfx-type-success-disabled !important;
    background-color: $cfx-type-success-light !important;
  }

  &--error--plain {
    color: $cfx-type-error !important;
    border-color: $cfx-type-error-disabled !important;
    background-color: $cfx-type-error-light !important;
  }

  &--warning--plain {
    color: $cfx-type-warning !important;
    border-color: $cfx-type-warning-disabled !important;
    background-color: $cfx-type-warning-light !important;
  }

  &--info {
    color: #ffffff;
    border-color: $cfx-type-info;
    background-color: $cfx-type-info;
  }
  &--info--disabled {
    color: #ffffff !important;
    border-color: $cfx-type-info-disabled !important;
    background-color: $cfx-type-info-disabled !important;
  }
  &--info--plain {
    color: $cfx-type-info !important;
    border-color: $cfx-type-info-disabled !important;
    background-color: $cfx-type-info-light !important;
  }
}
...
.u-primary-plain-hover {
  color: #ffffff !important;
  background: $cfx-type-primary-dark !important;
}

.u-default-plain-hover {
  color: $cfx-type-primary-dark !important;
  background: $cfx-type-primary-light !important;
}

.u-success-plain-hover {
  color: #ffffff !important;
  background: $cfx-type-success-dark !important;
}

.u-warning-plain-hover {
  color: #ffffff !important;
  background: $cfx-type-warning-dark !important;
}

.u-error-plain-hover {
  color: #ffffff !important;
  background: $cfx-type-error-dark !important;
}

.u-info-plain-hover {
  color: #ffffff !important;
  background: $cfx-type-info-dark !important;
}

.u-default-hover {
  color: $cfx-type-primary-dark !important;
  border-color: $cfx-type-primary-dark !important;
  background-color: $cfx-type-primary-light !important;
}
