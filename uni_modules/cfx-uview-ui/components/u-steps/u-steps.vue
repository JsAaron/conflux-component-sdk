...
$cfx-steps-item-number-width: 44rpx;
$cfx-steps-item-dot-width: 20rpx;
  ...
  .u-steps__item {
    ...
    &--row {
      ...
      .u-steps__item__line {
        ...
        &--dot {
          top: calc(#{$cfx-steps-item-dot-width} / 2);
        }

        &--number {
          top: calc(#{$cfx-steps-item-number-width} / 2);
        }
      }
    }
    ...
    &--column {
      ...
      .u-steps__item__line {
        ...
        &--dot {
          left: calc(#{$cfx-steps-item-dot-width} / 2);
        }

        &--number {
          left: calc(#{$cfx-steps-item-number-width} / 2);
        }
      }
    }
    ...
    &__num {
      ...
      align-items: center;
      justify-content: center;
      width: $cfx-steps-item-number-width;
      height: $cfx-steps-item-number-width;
    ...
    &__dot {
      width: $cfx-steps-item-dot-width;
      height: $cfx-steps-item-dot-width;
      @include vue-flex;
      border-radius: 50%;
    }
