...
.u-alert-tips {
  ...
  &--border--primary-disabled {
    border-color: $cfx-type-primary-disabled;
  }

  &--border--success-disabled {
    border-color: $cfx-type-success-disabled;
  }

  &--border--error-disabled {
    border-color: $cfx-type-error-disabled;
  }

  &--border--warning-disabled {
    border-color: $cfx-type-warning-disabled;
  }

  &--border--info-disabled {
    border-color: $cfx-type-info-disabled;
  }
}
