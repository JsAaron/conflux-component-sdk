...
.u-mode-plain-primary {
  ...
  color: $cfx-type-primary;
  border: 1px solid $cfx-type-primary;
}

.u-mode-plain-success {
  background-color: #ffffff;
  color: $cfx-type-success;
  border: 1px solid $cfx-type-success;
}

.u-mode-plain-error {
  background-color: #ffffff;
  color: $cfx-type-error;
  border: 1px solid $cfx-type-error;
}

.u-mode-plain-warning {
  background-color: #ffffff;
  color: $cfx-type-warning;
  border: 1px solid $cfx-type-warning;
}

.u-mode-plain-info {
  background-color: #ffffff;
  color: $cfx-type-info;
  border: 1px solid $cfx-type-info;
}
