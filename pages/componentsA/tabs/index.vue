<template>
	<view class="u-demo">
		<view>
			<u-alert-tips type="warning" title="使用 v-model='current' 代替 :current='current' @change='change' 其他不变"></u-alert-tips>
		</view>
		<view class="u-demo-wrap">
			<view class="u-demo-title">演示效果</view>
			<view class="u-demo-area">
				<u-toast ref="uToast"></u-toast>
				<u-tabs v-if="control" v-model="current" bg-color="#fafafa" :bold="bold" :active-color="activeColor" :list="list"
