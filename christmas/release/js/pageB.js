 ...
 */
PageB.prototype.next = function(options) {
    var dfd = $.Deferred();
    this.$boy.animate({
        "left": options.left,
        "top" : options.top,
 ...
 * @return {[type]} [description]
 */
PageB.prototype.change = function(callback){
    this.$root
        .addClass("changePage")
 ...
 * @return {[type]} [description]
 */
PageB.prototype.openWindow = function(){
    var that = this;
 ...
 * @return {[type]} [description]
 */
PageB.prototype.stopWalk = function(){
 ...
 * @return {[type]} [description]
 */
PageB.prototype.run = function(callback){
    var that = this;
    var next = function() {
 ...
 * @return {[type]} [description]
 */
PageB.prototype.createCloudyCircle = function() {
    //创建SVG元素
